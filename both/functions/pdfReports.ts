...
export function invoiceOrOrderPdf(pdfContent) {
  let array = [];
  let widths = []
  if (pdfContent.docTitle === "Invoice") {
    widths = [40, 40, 20, 70, '*', 50, 25, 50]
  } else if (pdfContent.docTitle === "Sales Order"){
    widths = [30, 40, 55, '*', 25, 50]
  }
              ...
              table: {
                ...
                body: [
                  [
                    ...
                    { text: 'Ordered', alignment: 'right', bold: true, border: [false, false, false, true] },
                    { text: 'Item Code', bold: true, border: [false, false, false, true] },
  ...
  switch (pdfContent.docTitle) {
    case 'Invoice':
      body = [
        ...
        [{ text: 'Order Number:', border: [false, false, false, false], style: 'tableHeaders' }, { text: pdfContent.orderInfo.number, border: [false, false, false, false], style: 'tableContent' }],
        [{ text: 'Order Date:', border: [false, false, false, false], style: 'tableHeaders' }, { text: moment(pdfContent.orderInfo.date).format("MM/DD/YYYY"), border: [false, false, false, false], style: 'tableContent' }],
    ...
    if (lineItem.type !== "comment") {
      let item = {
        ...
        table: {
          ...
          body: [
            [
              { text: lineItem.orderLineItemInfo.qtyOrdered, alignment: 'right', border: [false, false, false, false] },
              { text: lineItem.qtyShipped, alignment: 'right', border: [false, false, false, false] },
              { text: lineItem.orderLineItemInfo.qtyBackordered, alignment: 'right', border: [false, false, false, false] },
