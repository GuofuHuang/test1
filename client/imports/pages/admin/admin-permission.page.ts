    ...
    <mat-card>
      <section class="box" id="adminEachUser" >
        ...
        <form #permissionEditForm="ngForm">
          ...
          <mat-input-container class="inputContainer cursor-pointer" (click)="manageModule()" >
...
export class AdminPermissionPage implements OnInit{
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe((params: Params) => {
     ...
     let options = {};
     MeteorObservable.subscribe('userPermissions', query, {}, '').subscribe();

     MeteorObservable.autorun().subscribe(async() => {
       let permission = UserPermissions.collection.findOne(query);
       ...
       //     console.log('current permission', permissionInfo);
  ...
  removePermission(){
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        MeteorObservable.call('softDeleteDocument', "userPermissions", this.documentId).subscribe(updateInfo => {})
  ...
  manageModule() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        // };
        //
        // MeteorObservable.call('update', 'userPermissions', query, update).subscribe(res => {
        ...
        // MeteorObservable.call('findOne', 'userPermissions', query, {}).subscribe((res:any) => {
